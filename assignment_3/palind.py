...
#		numb_list1 = list(numb_str[0:(l/2)])
#		numb_list2 = list(numb_str[(l/2):])
		

		while j<(l/2):
		
			if (numb_list[(l/2)-j-1]!=numb_list[(l/2)+j])&(pal_numb_flag!=1):
				if numb_list[(l/2)-j-1]<numb_list[(l/2)+j]:
					if(j==0):
						numb_list[(l/2)-j-1] = str(int(numb_list[(l/2)-j-1])+1)
						numb_list[(l/2)+j] = str(int(numb_list[(l/2)-j-1]))
					else:
						numb_list[(l/2)-1] = str(int(numb_list[(l/2)-1])+1)
						numb_list[(l/2)] = str(int(numb_list[(l/2)-1]))
						numb_list[(l/2)-j-1] = str(int(numb_list[(l/2)-j-1]))
						numb_list[(l/2)+j] = str(int(numb_list[(l/2)-j-1]))
...
#				print "2 " + numb_list[(l/2)-j-1]
				pal_numb_flag = 1
			elif (numb_list[(l/2)-j-1]!=numb_list[(l/2)+j])&(pal_numb_flag==1):
#				temp = numb_str[(l/2)-j-1]
...
#		out_str = numb_str[((l-1)/2)]
		...
		while j<((l-1)/2):
			...
			if (numb_list[((l-1)/2)+j+1]!=numb_list[((l-1)/2)-j-1])&(pal_numb_flag!=1):
				if (numb_list[((l-1)/2)-j-1]<numb_list[((l-1)/2)+j+1]):
#					temp = str(int(numb_str[(l/2)-j-1])+1)

					numb_list[((l-1)/2)-j-1] = str(int(numb_list[((l-1)/2)-j-1]))
					numb_list[((l-1)/2)+j+1] = str(int(numb_list[((l-1)/2)-j-1]))
					numb_list[((l-1)/2)] = str(int(numb_list[((l-1)/2)])+1)
...
#				print "5 " + numb_list[((l-1)/2)-j-1]
				pal_numb_flag = 1
			elif (numb_list[((l-1)/2)+j+1]!=numb_list[((l-1)/2)-j-1])&(pal_numb_flag==1):
